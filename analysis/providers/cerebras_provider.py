...
class CerebrasProvider(BaseAIProvider):
    """
    Cerebras's API is OpenAI-compatible. Note: Cerebras rejects
    frequency_penalty/logit_bias/presence_penalty with a 400 error
    if supplied, so this provider intentionally sends only model and
